...
<!--                       <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="cnic" data-inputmask='"mask": "99999-9999999-9"' data-mask id="cnic" placeholder="CNIC">
                        </div>
                      </div>
        ...
        $.ajax({
             ...
             success: function(data){
                ...
                if(obj.status == true){
                  ...
                  setTimeout(hide_model_and_reset_school_form, 3500);
