                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" class="form-control" name="schoolName" required value="<?php echo set_value('schoolName');?>" id="title" placeholder="<?php echo @ucfirst($title); ?> Name">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" required name="district_id">
                            ...
                            <?php foreach ($districts as $district) : ?>
                              <option value="<?= $district->districtId;?>" <?php set_value('district_id'); ?> ><?= $district->districtTitle; ?></option>
                            <?php endforeach; ?>
                        </select>
                      </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" class="form-control" name="address" value="<?php echo set_value('address');?>" id="address" placeholder="<?php echo @ucfirst($title); ?> Address">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" class="form-control" name="schoolLandlineNumber" value="<?php echo set_value('schoolLandlineNumber');?>" id="schoolLandlineNumber" placeholder="<?php echo @ucfirst($title); ?> Land line Number">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" class="form-control" name="schoolMobileNumber" value="<?php echo set_value('schoolMobileNumber');?>" id="schoolMobileNumber" placeholder="<?php echo @ucfirst($title); ?> Mobile Number">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" required name="type_of_institute_id">
                          <?php if(count($type_of_institute)>0): ?>
                            <option>no data found</option>
                          <?php else:?>
                            <option>Select</option>
                            <?php foreach ($type_of_institute as $typeOfInsti) : ?>
                              <option value="<?= $typeOfInsti->typeOfInstituteId;?>" <?php echo set_select('type_of_institute_id',  $typeOfInsti->typeOfInstituteId); ?>> ><?= $typeOfInsti->toiTitle; ?></option>
                            <?php endforeach; ?>
                          <?php endif; ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" required name="gender_of_school">
                          ...
                          <?php foreach ($gender_of_school as $gender) : ?>
                            <option value="<?= $gender->genderOfSchoolId;?>" <?php echo set_select('gender_of_school',  $gender->genderOfSchoolId); ?> ><?= $gender->genderOfSchoolTitle; ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" required name="level_of_school">
                          ...
                          <?php foreach ($level_of_institute as $item) : ?>
                            <option value="<?= $item->levelofInstituteId;?>" <?php echo set_select('level_of_school',  $item->levelofInstituteId); ?> ><?= $item->levelofInstituteTitle; ?></option>
                          <?php endforeach; ?>
