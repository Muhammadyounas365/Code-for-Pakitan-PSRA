...
<!--                 </ul>
      ...
      <!--           <div class="row">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('user/edit/')?><?php echo $this->session->userdata('userId'); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
...
<!--       <form action="#" method="get" class="sidebar-form">
      ...
      <h3 class="text-center" style="color:white;"><strong>PSRA</strong></h3>
      <?php echo $menu_list; ?>
