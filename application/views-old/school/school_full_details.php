    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
      	<div class="col-sm-4 invoice-col">
            ...
            <strong>Registration #
              <?php if($school->schoolRegNumber != 0 ): ?>
                <?php echo @$school->schoolRegNumber; ?><?php endif; ?>
            </strong><br />
      	    <?php if(!empty($school->yearOfEstiblishment)): ?>
      	    	<?php echo "Estiblished In: ".$school->yearOfEstiblishment; ?>
      	    		<br>
      	    <?php endif; ?>
    ...
    <div class="clearfix"></div>
      ...
      <div class="row page_break_before">
        ...
        <div class="col-xs-12 table-responsive">
          ...
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Edit Physical Facilities', 'School/physical_facilities_view_edit');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-edit"></i> Edit Physical Facilities
          </button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row page_break_before">
        ...
        <div class="col-xs-12 table-responsive">
          ...
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Add New Enrollement To School', 'School/school_enrollement_add_ajax');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-plus"></i> Add Enrollement
          </button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row page_break_before">
        ...
        <div class="col-xs-12 table-responsive">
          ...
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Add New Staff Member To School', 'School/school_staff_add_ajax');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-plus"></i> Add Staff
          </button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row page_break_before">
        ...
        <div class="col-xs-12 table-responsive">
          ...
          <div class="row">
            <div class="col-sm-8">
              Whether the above fees are mentioned in the prospectus/admission form <strong><?php echo $school_fee_mentioned_in_form->feeMentionedInForm; ?></strong>
            </div>
            
          </div>
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Add Student Dues/Funds Details To School', 'School/school_fund_add_ajax');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-plus"></i> Add Student Dues/Funds Details
          </button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row page_break_before">
        ...
        <div class="col-xs-10 col-xs-offset-1 table-responsive">
          ...
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Edit Security Measures', 'School/security_measures_edit_view_ajax_modal');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-edit"></i> Edit Security Measure
          </button>
        </div>
        <!-- /.col -->
      </div>
